...
class base_forum extends base_db {
  ...
  */
   ...
   * @param int|string $prefix Identified the source of the comment
   * @access public
   * @return boolean
   */
   ...
   * @param int $pageId optional, default value ''
   * @param string $prefix
   * @access public
  ...
  */
   ...
   * @return boolean
   */
  function loadLastEntriesInCateg($categId, $maxCount, $offset = NULL) {
  ...
  */
  function addEntry($entryData, $richtextEnabled = FALSE, $mode = 0) {
    ...
    if (isset($entryData['entry_text'])) {
      ...
      $rejectAttackStrings = $options->get('REJECT_ATTACK_STRINGS', '');
      ...
      $entryMaxLength = $options->get('ENTRY_MAX_LENGTH', 0);
      if ($entryMaxLength > 0) {
