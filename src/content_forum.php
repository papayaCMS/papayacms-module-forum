<?php
/**
* Page module to display forum content.
**************************************************************************************
* +---------------+        +--------------+  * show/browse categories
* | content_forum |------->| base_content |  * list forums in categories
...
*                          +--------------+
**************************************************************************************
* This page module is used to make papaya pages being a forum. This module
...
* settings. When in category mode, the user can browse through the forum categories
* and select any forum he finds. In forum mode when provided with a specific forum
* the user can't do that, he is restricted to only one forum. User rights may be
* set for specific actions within the forum this page shows allowing editors to
...
* @version $Id: content_forum.php 39287 2014-02-19 21:34:07Z weinert $
*/
...
* @subpackage Free-Forum
*/
class content_forum extends base_content {
